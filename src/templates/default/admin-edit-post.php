...
echo '
<div id="id_content" class="w900 border-style1 bg">
        <div class="section">
			<p>
				<input type="text" style="width:520px" name="title" value="',$p_title,'" class="sll" />
			</p>
           <div>
			<script type="text/plain" id="content" name="content" value="',$p_content,'"></script>
			</div>
...
<script type="text/javascript">
    //实例化编辑器
    var ue = UE.getEditor("content", window.UEDITOR_CONFIG);
	
	ue.addListener("ready", function (){
        ue.setHtmlContent("',htmlspecialchars($p_content),'");
    });
