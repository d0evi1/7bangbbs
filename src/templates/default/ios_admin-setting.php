...
<table cellpadding="5" cellspacing="8" border="0" width="100%" class="fs12">
    ...
    <tr bgcolor="#EEE" height="24">
        <td width="120" align="right"> » </td>
        <td width="82%" align="left">QQ登录设置（可选，不用则留空），参考<a href="http://7bangbbs.sinaapp.com/t-263" target="_blank">用QQ登录</a></td>
    </tr>
    <tr>
    ...
    <tr bgcolor="#EEE" height="24">
        <td width="120" align="right"> » </td>
        <td width="auto" align="left">附件设置，参考 <a href="http://7bangbbs.sinaapp.com/t-199" target="_blank">又拍云结合</a></td>
    </tr>
    <tr>
