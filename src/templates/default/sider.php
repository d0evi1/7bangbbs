...
echo '
<div class="sider-box">
    <div class="sider-box-title">管理员面板 （<a href="http://7bangbbs.sinaapp.com/" target="_blank">7bangBBS官方支持</a>）</div>
...
echo '
<div class="sider-box">
    <div class="sider-box-title">&raquo; <a href="http://7bangbbs.sinaapp.com/t-101">关于7bangBBS及开源下载</a></div>
