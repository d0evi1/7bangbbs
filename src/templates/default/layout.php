...
$options['base_avatar_url'] = 'http://avatar.stor.sinaapp.com';
...
<head>
	...
	<link href="/css/onlinedemo.css" rel="stylesheet" type="text/css" />
	<link rel="shortcut icon" href="/favicon.ico" type="image/x-icon" />
	<link href="/feed" rel="alternate" title="',htmlspecialchars($options['name']),' - Feed" type="application/atom+xml"/>
...
<div class="header-wrap">
    <div class="header">
        <div class="logo">
			<a href="/" name="top">',htmlspecialchars($options['name']),'</a></div>
        <div class="scbox">
...
{
	// 头像
    echo '<img src="',$options['base_avatar_url'],'/',$cur_user['avatar'],'.jpg" alt="',$cur_user['name'],'"/>&nbsp;&nbsp;&nbsp;';
    ...
    if($options['qq_appid'] && $options['qq_appkey']){
        ...
        if(!$options['close_register']){
            echo '&nbsp;&nbsp;&nbsp;<a href="/register" rel="nofollow">注册</a>';
        }
    }
}
...
echo '    </p>
    <p>Powered by <a href="http://www.7bangbbs.com" target="_blank">7bangbbs v0.1 ',SAESPOT_VER,'</a></p>';
