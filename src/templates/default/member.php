...
if($is_spider){
    echo '<img src="',$options['base_avatar_url'],'/',$m_obj['avatar'],'.jpg" alt="',$m_obj['name'],'" />';
}else{
    echo '<img src="/static/grey.gif" data-original="',$options['base_avatar_url'],'/',$m_obj['avatar'],'.jpg" alt="',$m_obj['name'],'" />';
}
echo '    </a></div>
